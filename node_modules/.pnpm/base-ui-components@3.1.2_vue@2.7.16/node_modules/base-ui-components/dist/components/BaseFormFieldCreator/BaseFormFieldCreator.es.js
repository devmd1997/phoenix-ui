import n from "../../mixins/i18n.es.js";
import "./BaseFormFieldCreator.vue_vue_type_style_index_0_scoped_05f05736_lang.es.js";
...
const o = {
  ...
  components: {
    ...
    BaseDateInput: () => import("../BaseDateInput/BaseDateInput.es.js").then((t) => t.default || t),
    BaseForm: () => import("../BaseForm/BaseForm.es.js").then((t) => t.default || t),
    BaseToggle: () => import("../BaseToggle/BaseToggle.es.js").then((t) => t.default || t),
    BaseLink: () => import("../BaseLink/BaseLink.es.js").then((t) => t.default || t)
  },
  mixins: [n],
  props: {
    fieldKey: {
  ...
  computed: {
    fieldElement() {
      return this.fieldType === "text" || this.fieldType === "integer" || this.fieldType === "float" ? () => import("../BaseInput/BaseInput.es.js") : this.fieldType === "multiline" ? () => import("../BaseMultilineTextInput/BaseMultilineTextInput.es.js") : this.fieldType === "autocomplete" ? () => import("../BaseAutocompleteInput/BaseAutocompleteInput.es.js") : this.fieldType === "chips" ? () => import("../BaseChipsInput/BaseChipsInput.es.js") : this.fieldType === "chips-below" ? () => import("../BaseChipsBelow/BaseChipsBelow.es.js") : null;
    },
    dateType() {
      ...
      return !this.field.properties && (!this.field.items || !this.field.items.properties) ? "single" : t.includes("date_to") && t.includes("time_to") ? "daterangetimerange" : t.includes("date") && t.includes("time_to") ? "datetimerange" : t.includes("time") ? "datetime" : t.includes("date_to") ? "daterange" : "single";
    },
    groupFormFields() {
  ...
  methods: {
    ...
    setMultilineDropDown(t) {
      this.$set(this.fieldValueInt, "type", t.source ? t : null);
    },
    onEnter(t) {
      this.fieldType !== "multiline" ? t.preventDefault() : this.$emit("keydown", t);
    },
    fetchBoxData() {
...
var d = function() {
  ...
  } }], null, !0) }, "BaseForm", e.fieldGroupParams, !1))], 1)]) : e.fieldType === "boolean" ? [l("BaseToggle", e._b({ staticClass: "base-form-field-creator__toggle", attrs: { name: e.fieldKey, label: e.labelInt, checked: e.fieldValue, "bind-slot-to-state": e.fieldProps.bindSlotToState || !0 }, on: { clicked: function(i) {
    return e.$emit("field-value-changed", i);
  } } }, "BaseToggle", e.fieldProps, !1), [e.formFieldXAttrs.subtext && e.formFieldXAttrs.subtext.value ? l("BaseLink", { attrs: { source: e.formFieldXAttrs.subtext.source || "", url: e.formFieldXAttrs.subtext.url || "", value: e.formFieldXAttrs.subtext.value } }) : e._e()], 1)] : e._e()], 2);
}, s = [], f = /* @__PURE__ */ a(
  o,
  d,
  s,
...
//# sourceMappingURL=BaseFormFieldCreator.es.js.map
