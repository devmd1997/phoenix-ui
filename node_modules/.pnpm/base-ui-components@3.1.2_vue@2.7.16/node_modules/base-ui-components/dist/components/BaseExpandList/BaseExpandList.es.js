import n from "../BaseButton/BaseButton.es.js";
import r from "./BaseExpandListRow.es.js";
import "./BaseExpandList.vue_vue_type_style_index_0_scoped_27bf38da_lang.es.js";
  ...
  methods: {
    ...
    sort({ direction: e }, t) {
      if (e === "up" && t - 1 < 0 || e === "down" && t + 1 >= this.dataInt.length) {
        this.$refs.baseExpandListRow[t].useSupportiveText = !1, this.$refs.baseExpandListRow[t].movable = !0;
        return;
      }
      const a = e === "up" ? t - 1 : t + 1, s = t, i = this.dataInt;
      i.splice(a, 0, i.splice(s, 1)[0]), this.dataInt = i, this.assertiveText = this.supportiveText.moved.replace("{pos}", a + 1).replace("{total}", this.dataInt.length), this.$refs.baseExpandListRow[a].useSupportiveText = !1, this.$refs.baseExpandListRow[a].movable = !0;
    },
    reset() {
    ...
    supportive(e, t) {
      const a = this.dataInt[t].hidden ? this.supportiveText.hidden : this.supportiveText.visible, s = this.supportiveText[e].replace("{state}", a);
...
var p = function() {
  ...
  }), 1), t.edit ? [a("div", { staticClass: "supportive-text", attrs: { "aria-live": "assertive" } }, [t._v(" " + t._s(t.assertiveText) + " ")]), a("p", { staticClass: "supportive-text", attrs: { id: `draggable-${t._uid}` } }, [t._v(" " + t._s(t.supportiveText.description) + " ")]), a("div", { ref: "baseExpandListDraggable", staticClass: "base-expand-list__draggable", attrs: { tabindex: "0", "aria-labelledby": `draggable-${t._uid}` } }, [a("draggable", { staticClass: "base-expand-list__draggable", attrs: { draggable: ".base-expand-list__draggable__item", handle: t.dragHandle, disabled: t.disabled, animation: "150" }, model: { value: t.dataInt, callback: function(s) {
    t.dataInt = s;
  }, expression: "dataInt" } }, t._l(t.dataInt, function(s, i) {
    return a("BaseExpandListRow", { key: i, ref: "baseExpandListRow", refInFor: !0, staticClass: "base-expand-list__draggable__item", attrs: { data: s, edit: !0, "edit-hide-text": t.editHideText, "edit-show-text": t.editShowText, "control-type": t.controlType, disabled: t.disabled }, on: { supportive: function(d) {
      return t.supportive(d, i);
    }, sorted: function(d) {
      return t.sort(d, i);
...
//# sourceMappingURL=BaseExpandList.es.js.map
